...
module.exports = function() {
  ...
  function openPopup(option) {
    ...
    var table = $('<table/>');
    var thead = $('<thead><tr><th><th>wave1<th>wave2<th>wave3<th>wave4<th>wave5<th>wave6</thead>');
    var tbody = $('<tbody/>');
    var tr1 = $('<tr><th>開始時刻</tr>');
    var tr2 = $('<tr><th>終了時刻</tr>');
    var tr3 = $('<tr><th>所要時間</tr>');
  ...
  function openNextPrev() {
    ...
    var popup = $this.closest('.youtube-popup');
    var nextPlayerid = popup.find('object').attr('id').replace(/\d+$/, function(d) {
      return +d + diff;
    });
